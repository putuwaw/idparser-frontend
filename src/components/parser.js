				...
				<Col lg={8} className="m-auto text-center z-30">
					...
					<div className="pt-3">
						<Form>
								...
								<button className="bg-blue-400 hover:bg-blue-500 sm:w-full md:w-auto text-white rounded-md m-auto py-3 ms-2 px-24 mt-3" onClick={(e) => parser(e)}>Periksa</button>
						</Form>
					</div>
				</Col>
